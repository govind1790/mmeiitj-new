          ...
          <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>MME IIT Jodhpur</span></h2>
                <p class="animate__animated animate__fadeInUp" id="slidetext">The Department of Metallurgical and Materials Engineering at IIT Jodhpur was established in 2017, and the Department is committed to high-quality education and research in the broad area of Materials Engineering. </p>
                <a href="#about" class="btn-get-started scrollto animate__animated animate__fadeInUp">Read More</a>              </div>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url(assets/img/slide/slide-3.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p class="animate__animated animate__adeInUp" id="slidetext">Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et est quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut. Similique ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et tempore modi architecto.</p>
                <a href="#about" class="btn-get-started scrollto animate__animated animate__fadeInUp">Read More</a>              </div>
            </div>
          </div>
...
<p><marquee behavior="scroll" onmouseover="this.stop()" onmouseout="this.start()">
									  ...
									  <a href="https://drive.google.com/file/d/1WwTpuZzCBOhq7UYJsG0P_f08wGMLYB9I/view?usp=share_link" target="_blank"><strong>MSE Newsletter (Volume 4, Issue 2, July - December 2022)</strong> <img src="assets/img/new.gif"></a>  &nbsp;&nbsp;|&nbsp;&nbsp;

<a href="data/MSE_PG_Courses.pdf" target="_blank"><strong><strong>P. G. Syllabus</strong></strong></a> &nbsp;&nbsp;|&nbsp;&nbsp;  <a href="ug-core-courses"><strong><strong>U. G. Syllabus</strong></strong></a> 
...
<!-- End latest scrolling news --->
        ...
        <div class="row content">
          <div class="col-lg-6">
            <h3 class="mfh">Message from Head</h3>
        
		
		
		 <div class="icon-box" style="border:solid #d6d6d6 1px; border-radius: 5px; padding:10px;">
		   <img src="assets/img/People/dr_ravi.jpg" style="width:200px; float:left; margin-right:10px;">
		   <p>
		   The Department of Metallurgical and Materials Engineering at IIT Jodhpur is working towards building future generation minds rich in skills and innovation to be the best in the outside world. Faculty Members in the department have expertise in diverse areas of Materials Engineering. They are actively involved in conducting translational research in the fundamental and applied areas of Materials Engineering. The department frequently organizes invited lectures and workshops to share research findings, train students on the state of the art experimental and computational techniques to promote the development of skill sets. The Department welcomes bright people who aspire to utilize the power of ambitious research and teaching to shape a better future.</p>

The key focus areas of the department are (but not limited to):<br>

<ol>
<li>Materials Design and Processing</li>
<li>Advanced Structural and Functional Materials</li>
<li>Computational Materials Engineering</li>
<li>Extractive and Process Metallurgy</li>
<li>Materials Testing and Characterization</li>
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
		   <h3 class="mfh">News and Activities</h3>
            
			<iframe src="scroll/conference.html" width="100%" height="513px" frameborder="0" scrolling="no" allowfullscreen></iframe>
    ...
    <!-- ======= About List Section ======= -->
    <section id="about-list" class="about-list section-bg">
      <div class="container">
            ...
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <div class="portfolio-links">
                  ...
                  <a href="portfolio-details.html" title="More Details"><i class="ri-links-fill"></i></a>                </div>
              </div>
            </div>
          </div>
            ...
            <div class="member d-flex align-items-start">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  ...
                  <a href=""> <i class="ri-linkedin-box-fill"></i> </a>                </div>
              </div>
            </div>
          </div>
